class Pairing < ApplicationRecord
  BASE_SYSTEM_PROMPT = <<~PROMPT.freeze
    ...
    After using the create_workout_plan tool, reply in 2–3 sentences only. Name the plan and say one thing that makes it a great fit for this pair, then fire them up to get started.
  PROMPT
