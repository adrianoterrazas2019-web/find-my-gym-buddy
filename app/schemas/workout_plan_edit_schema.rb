class WorkoutPlanEditSchema < RubyLLM::Schema
  string :title, description: "Plan title — keep the current value if the user did not ask to change it"
  string :description, description: "Plan description — keep the current value if the user did not ask to change it"
